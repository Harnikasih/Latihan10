...
<table id="myTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><span class="badge <?= $row_kategori['status']== 1?'text-bg-success':'text-bg-danger';?>"><?= $row_kategori['status'] == 1?'Akti':'Tidak Aktif'; ?></span></td>
            <td>
            <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row_kategori['id_kategori'];?>" class="text-info"><i class="bi bi-pencil-square"></i></a>
                        ...
                        <a href="" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row_kategori['id_kategori'];?>" class="text-danger"><i class="bi bi-trash-fill"></i></i></a>
                        <!-- Modal -->
